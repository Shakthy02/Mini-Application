...
class ATM{
    ...
    public static boolean adminpass(){
        ...
        for(int x=1;x<=3;x++){
            ...
            if(name.equals("Shakthy") && password.equals("admin") && a<=3){
                ...
                b=false;
                if(x==1){
                    System.out.println("Only 2 Attempts left");
                }
                else if(x==2){
...
public static void main(String args[]){
    ...
    atm = new ATM[3];
    atm[0] = new ATM("Shakthy", "1234", 5000);
    atm[0].User_Statement = new ArrayList<>();
    atm[1] = new ATM("Harini", "4567", 6000);
    atm[1].User_Statement = new ArrayList<>();
    atm[2] = new ATM("Sri", "8910", 3000);
         ...
         ;
            ...
            if(m==1){
               ...
               // System.out.print("-/");
                ...
                System.out.println("ATM balance : Rs "+balance);
            ...
            if(o==1){
                ...
                if(balance>=withdraw && withdraw>0 && atm[c].userbalance>=withdraw && withdraw%100==0){
                    ...
                    System.out.println("Available amount at ATM is Rs : "+balance);
                }
                else{
                    System.out.println("Invalid Amount");
                    System.out.println("Your Account balance is Rs : "+atm[c].userbalance);                   
                }
            }
            else if(o==2){
                System.out.println("Account Balance is Rs "+atm[c].userbalance);
                
            }
            else if(o==3){
                System.out.println("Current ATM balance is Rs : "+balance);
            }
            else if(o==4){
